  ...
  methods (Access = 'protected')
    function [nodes, weights] = configure(this, ~)
      if this.maximalLevel > 20
        warning('The maximal level is too high; changing to 20.');
      ...
      for i = 1:level
        ...
        %
        quadrature = Quadrature.ClenshawCurtis('method', 'sparse', ...
          'level', i - 1, 'growth', 'full-exponential');
        this.quadratureNodes{i} = transpose(quadrature.nodes(:));
